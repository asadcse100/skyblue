...
@if($page_post->layout === 'home_page_layout')
    <div class="parent-area padding-top-20">
...
@if($page_post->layout === 'home_page_layout_two')
    <div class="recent-stories-area-wrapper index-01" data-padding-top="20" >
    ...
    <div class="parent-area">
        <div class="container custom-container-01">
            <div class="row">
                ...
                <div class="col-sm-10 col-md-6 col-lg-5 col-xl-4" data-padding-bottom="20">
                    <div class="widget-area-wrapper style-{{$page_post->widget_style}}">
...
@if($page_post->layout === 'home_page_layout_three')
    ...
    <div class="recent-stories-area-wrapper index-04" data-padding-top="0" data-padding-bottom="30">
        <div class="container custom-container-01">
            <div class="row">
                <div class="col-xl-9">
                    {!! \App\PageBuilder\PageBuilderSetup::render_frontend_pagebuilder_content_for_dynamic_page('dynamic_page_with_sidebar',$page_post->id) !!}
                ...
                <div class="col-sm-7 col-md-6 col-lg-6 col-xl-3">
                    <div class="widget-area-wrapper" data-padding-top="20" >
                        {!! render_frontend_sidebar($page_post->sidebar_layout,['column' => false]) !!}
                    </div>
                </div>
    ...
    <div class="mixed-area-wrapper index-04">
        <div class="container custom-container-01 d-none">
            <div class="row">
                ...
                <div class="col-sm-7 col-md-6 col-lg-6 col-xl-3" data-padding-bottom="30" data-padding-top="20">
...
@if($page_post->layout === 'sidebar_layout')
    <div class="{{$page_post->page_class }}" data-padding-top="20" data-padding-bottom="30">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    {!! \App\PageBuilder\PageBuilderSetup::render_frontend_pagebuilder_content_for_dynamic_page('dynamic_page_with_sidebar',$page_post->id) !!}

                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @can('user-edit')
                                                    <a href="#" data-id="{{$data->id}}" data-username="{{$data->username}}" data-imageid="{{$data->image}}" data-image="{{$img_url}}" data-name="{{$data->name}}" data-email="{{$data->email}}" data-phone="{{$data->phone}}" data-address="{{$data->address}}" data-state="{{$data->state}}" data-city="{{$data->city}}" data-zipcode="{{$data->zipcode}}" data-country="{{$data->country}}" data-designation="{{$data->designation}}" data-description="{{$data->description}}" data-facebook_url="{{$data->facebook_url}}" data-twitter_url="{{$data->twitter_url}}" data-instagram_url="{{$data->instagram_url}}" data-linkedin_url="{{$data->linkedin_url}}" data-email_verified="{{$data->email_verified}}" data-toggle="modal" data-target="#user_edit_modal" class="btn btn-primary btn-sm mb-3 mr-1 user_edit_btn">
                                                        <i class="ti-pencil"></i>
                                                    </a>

                                                    <a class="btn btn-success btn-sm mb-3 text-white user_permission_btn" data-toggle="modal" data-target="#user_permission_modal" data-id="{{$data->id}}" data-auto_post_approval="{{$data->auto_post_approval}}" data-is_banned="{{$data->is_banned}}" data-post_permission="{{$data->post_permission}}">
                                                        {{__('Permissions')}}
                                                    </a>

                                                    <a href="#" data-id="{{$data->id}}" data-toggle="modal" data-target="#user_change_password_modal" class="btn btn-info btn-sm mb-3 mr-1 user_change_password_btn">
                                                        {{__("Change Password")}}
                                                    </a>
